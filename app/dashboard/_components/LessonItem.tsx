    ...
    return (
        <Link href={`/dashboard/${slug}/${lesson.id}`}
            className={buttonVariants({
                ...
                completed &&
                    "bg-green-100 dark:bg-green-900/30 border-green-300 dark:border-green-700 hover:bg-green-200 dark:hover:gb-green-900/50 text-green-800 dark:text-green-200",
